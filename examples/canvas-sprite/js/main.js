...
$(function(){
  var SpriteStroker, PrintingStroker, ss, ps, $sprite, $printing, $sdelay, $cdelay, $speed, $stroke, $char, $arrows, $debug, inputChanged, $progress, update;
