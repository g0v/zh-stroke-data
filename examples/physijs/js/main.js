...
*/
(function(){
  var $body, renderer, scene, geometry, material, camera, light, materialFront, block_material, ground, centroids, strokes, groups, i$, len$, stroke, shape, path, tokens, isOutline, cmd, extrusionSettings, doAddChar, render, controls;
  ...
  block_material = Physijs.createMaterial(new THREE.MeshLambertMaterial({
  ...
  ground = new Physijs.BoxMesh(new THREE.CubeGeometry(10000, 500, 10000), material, 0);
