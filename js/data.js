...
(function(){
  var sax, ByteBuffer, fromXML, undelta, undeltaR, scale, size, fromBinary, fromScanline;
  sax = require('sax');
  ...
  fromBinary = function(buffer, done){
    var bb, numWords, ids, offsets, i$, data, res$, lresult$, numStrokes, j$, numCmds, numCoords, outline, res1$, k$, type, xs, ys, i, len$, cmd, numTracks, numSizes, idxSizes, ss, track, idx, result;
