...
(function(){
  var options, AABB, Comp, Track, Stroke;
  options = {
    dim: 2150,
    scales: {
      fill: 0.025,
    ...
    function Comp(children, aabb){
      ...
      if (!this.aabb) {
        ...
        this.children.forEach(function(child){
          child.parent = this$;
          this$.aabb.addPoint(child.aabb.min);
          return this$.aabb.addPoint(child.aabb.max);
        });
      }
  ...
  Track = (function(superclass){
    ...
    function Track(data, options){
      ...
      this.options = options != null
        ? options
        : {};
      Track.superclass.call(this, null, new AABB);
  ...
  window.zhStrokeData.Comp = Comp;
  window.zhStrokeData.Track = Track;
  window.zhStrokeData.Stroke = Stroke;
